...
CFLAGS_MODULE   = -O3 -mcpu=cortex-a9 -mtune=cortex-a9 -mfpu=vfpv3-d16 -ftree-vectorize -mfloat-abi=hard -ffast-math -fsingle-precision-constant -marm -mstructure-size-boundary=32 --param l2-cache-size=1024
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
